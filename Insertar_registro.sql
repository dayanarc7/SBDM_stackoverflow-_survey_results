...
-- PARA VERIFICAR EL TOTAL DE REGISTROS DE LA ENCUESTA DESCOMENTAR EL SELECT DE ABAJO 
-- SELECT COUNT(*) FROM CLEAN2014

-- INSERTANDO UN NUEVO REGISTRO A LA ENCUESTA DE 2014

INSERT INTO clean2014 (pais, edad, sexo, experiencia, ocupacion, ingresos, sector, lenguaje_python,lenguaje_sql,año)
VALUES ('Colombia', '20-24', 'M', '<2', 'Back-End Web Developer', '<$20,000', 'Consulting', 'python', 'sql', '2014')

-- PARA VERIFICAR LA INSERCIÓN DEL REGISTRO DESCOMENTAR EL SELECT DE ABAJO Y COMPROBAR LA APARICION DE UNA NUEVA FILA
-- SELECT COUNT(*) FROM CLEAN2014

-- SELECT * FROM CLEAN2014
